...
function Building1(props: { i: BuildingProps }) {
  return (
      ...
      <Link href={`/Adverts`} className="rounded-sm cursor-pointer hover:p-0 sm:hover:mx-4 p-3 m-24 hover:bg-neutral-700 sm:hover:p-0 hover:border-2 duration-500 my-4 col-span-7 sm:col-span-6 md:col-span-4 lg:col-span-3 grid grid-cols-12 h-96 sm:m-5 border border-neutral-700">
