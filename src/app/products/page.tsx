...
interface BuildingProps {
  ...
  function MeinMap(props: { mins: BuildingProps }) {
    return (<>
        <Link href={`/Adverts`} className="hover:bg-neutral-700  duration-500 hover:p-4 xl:col-span-12 lg:col-span-6 col-span-12 cursor-pointer grid grid-cols-12 ml-2 xl:border-t p-3 h-60 border-r xl:border-r-0 border-neutral-700">
